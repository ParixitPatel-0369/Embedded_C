Bitwise Operators (Basics Level):
...
output: 00000101
4. WAP to count the bits set (bit value 1 ) in an integer? Find out and compare
...
e.g. if x = 10101010 (170 decimal) and y = 10100111 (167 decimal) and n = 3 and p
= 6 then
you need to strip off 3 bits of y (111) and put them in x at position 10xxx010 to get
answer
10111010. Your answer should print out the result in binary form although input can
be in
decimal form.
